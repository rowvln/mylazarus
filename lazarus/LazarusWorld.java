/* The LazarusWorld class is where everything keeps running until the end. Main game is ran from here */
package lazarus;
...
private Thread thread;
  ...
  public Graphics2D createGraphics2D(int w, int h){
    ...
    if ((this.bufferedImage == null) || (this.bufferedImage.getWidth() != w) || (this.bufferedImage.getHeight() != h)){
      this.bufferedImage = ((BufferedImage)createImage(w, h));
    }
    g2 = this.bufferedImage.createGraphics();
